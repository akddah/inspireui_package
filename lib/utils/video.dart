...
class Videos {
  static final log = LoggerDebug(constTitle: 'Videos in inspire_ui');
  ...
  static String? _getYoutubeLink(String? content) {
    final regExp = RegExp('https://www.youtube.com/((v|embed))/?[a-zA-Z0-9_-]+', multiLine: true, caseSensitive: false);
  ...
  static String? _getFacebookLink(String? content) {
    ...
    final regExp = RegExp('https://www.facebook.com/[a-zA-Z0-9.]+/videos/(?:[a-zA-Z0-9.]+/)?([0-9]+)', multiLine: true, caseSensitive: false);
  ...
  static String getInstagramLink(String? content) {
    final regExp = RegExp('instagram.com/(p|reel)/?[a-zA-Z0-9_-]+', multiLine: true, caseSensitive: false);
  ...
  static Future<Response> getWorkingProxyLink(proxyUrl, httpClient) async {
    return await http.post(
      ...
      body: {
        ...
        'token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJiYXIiLCJpYXQiOjE2NjE3Njg5Mjd9.cIXKYIP0BQuf-SdNQpBca0s4yPDq6-DrPVwMStYJE1c',
      },
    );
  }
}
